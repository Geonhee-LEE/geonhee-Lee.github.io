...
* __The goal of reinforcement learning))
...
<figure>
  <img alt="An image with a caption" src="/assets/img/CS294/LEC5/3.png" class="lead"   style="width:480px; height:=360px"/>
</figure>


* __Direct policy differentiation__
  * Policy gradient를 직접적으로 policy의 weight를 갱신.
  * 따라서, objective function을 바로 미분하여 gradient descent(or ascent) 방법을 이용하여 최적점(최소지점 or 최대지점)을 찾는다.
