...
<figure>
  <img alt="An image with a caption" src="/assets/img/ML/week1/1.png" class="lead" data-width="240px" data-height="180px" />
</figure>

- Response is
  - $$P(\theta) \propto P(D|\\midtheta) P(\theta) \propto \theta ^{a_H} (1-\theta)^{a_T }\theta ^{\alpha-1} (1-\theta)^{\beta -1 } = \theta ^{a_H + \alpha-1} (1-\theta)^{a_T + \beta -1 }$$
...
<figure>
  <img alt="An image with a caption" src="/assets/img/ML/week1/2.png" class="lead" data-width="240px" data-height="180px" />
  <img alt="An image with a caption" src="/assets/img/ML/week1/3.png" class="lead" data-width="240px" data-height="180px" />
</figure>
